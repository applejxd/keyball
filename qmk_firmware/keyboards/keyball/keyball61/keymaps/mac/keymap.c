...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = LAYOUT_universal(
    ...
    MO(1)    , KC_Z     , KC_X     , KC_C     , KC_V     , KC_B     , KC_LBRC  ,              KC_RBRC, KC_N     , KC_M     , KC_COMM  , KC_DOT   , KC_SLSH  , KC_RSFT  ,
    KC_ESC   , KC_LCTL  , KC_LALT  , KC_LGUI,LT(1,KC_LNG2),LT(2,KC_SPC),LT(3,KC_LNG1),       KC_BSPC,LT(2,KC_ENT),_______  ,_______   , _______  , KC_RALT  , KC_BSLS
  ),
  // US 配列(印字)を JP キーボード(ソフト設定)として使用
  [1] = LAYOUT_universal(
    S(KC_GRV), S(KC_1)   , S(KC_2)    , S(KC_3)  , S(KC_4)  , S(KC_5)  ,                                  S(KC_6)  , S(KC_7)  , S(KC_8)  , S(KC_9)  , S(KC_0)   , S(KC_INT1),
    ...
    _______  , S(KC_Z)   , S(KC_X)    , S(KC_C)  , S(KC_V)  , S(KC_B)  ,S(KC_LBRC),           S(KC_RBRC), S(KC_N)  , S(KC_M)  ,S(KC_COMM), S(KC_DOT), S(KC_SLSH), S(KC_RSFT),
    S(KC_ESC), S(KC_LCTL), S(KC_LALT) , S(KC_LGUI), _______  , _______ , _______  ,            _______  , _______ , _______  , _______  , _______  , S(KC_RALT), S(KC_BSLS)
  ),
  ...
  [5] = LAYOUT_universal(
    ...
    _______  , _______   , S(G(KC_S)) , _______  , _______  , _______  ,                                  _______  , C(KC_Z)  , _______  , A(KC_TAB), _______  , _______  ,
    _______  , _______   , G(KC_S)    , G(KC_E)  , C(KC_O)  , _______  ,                                  G(KC_A)  , _______  , C(KC_W)  , _______  , _______  , _______  ,
    _______  , _______   , _______    , A(KC_F4) , _______  , G(KC_UP), _______ ,             _______  , _______  , _______  , _______  , _______  , _______  , _______  ,
