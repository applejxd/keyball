...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = LAYOUT_universal(
    ...
    _______  , KC_Z     , KC_X     , KC_C     , KC_V     , KC_B     , _______  ,      _______, KC_N     , KC_M     , KC_COMM  , KC_DOT   , LT(2,KC_SLSH), _______  ,
  ...
  [1] = LAYOUT_universal(
    _______  , _______    , _______  , _______    , _______ , _______    ,                     _______    , _______    , _______    , _______    , _______ , _______ ,
    _______  , S(KC_1)    , KC_LBRC  , S(KC_3)    , S(KC_4) , S(KC_8)    ,                     S(KC_9)    , S(KC_6)    , S(KC_QUOT) , KC_SLSH    , KC_INT1 , _______ ,
    _______  , S(KC_LBRC) , KC_EQL   , S(KC_INT3) , S(KC_5) , KC_RBRC    ,                     KC_NUHS    , KC_MINS    , S(KC_SCLN) , S(KC_SLSH) , KC_QUOT , _______ ,
    _______  , S(KC_EQL)  , _______  , S(KC_MINS) , _______ , S(KC_RBRC) , _______ ,  _______, S(KC_NUHS) , S(KC_INT1) , S(KC_COMM) , S(KC_DOT)  , S(KC_2) , _______ ,
  ...
  [3] = LAYOUT_universal(
    ...
    C(KC_LSFT),G(KC_DOWN)  , OSL(5)   , C(KC_C)  , KC_PGDN  , KC_LEFT  , C(KC_RBRC),          C(KC_NUHS), KC_DOWN  , KC_ENT   ,C(KC_COMM),C(KC_DOT) , C(KC_Z)  , _______ ,
