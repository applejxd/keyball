...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [KL_BASE] = LAYOUT_universal(
    ...
    KC_LSFT  , LT(KL_SFT,KC_Z), KC_X     , KC_C   , KC_V           , KC_B             , KC_LBRC             , KC_RBRC, KC_N               , KC_M    , KC_COMM  , KC_DOT   , LT(KL_SFT,KC_SLSH), KC_BSLS ,
    KC_ESC   , KC_LCTL        , KC_LALT  , KC_LGUI, LSFT_T(KC_LNG2), LT(KL_SMB,KC_SPC), LT(KL_EMACS,KC_LNG1), KC_BSPC, LT(KL_NUMFN,KC_ENT), _______ , _______  , _______  , KC_RSFT           , MO(KL_SFT)
  ),
