...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT_universal(
    ...
    S(KC_ESC), S(KC_LCTL), S(KC_LALT) , S(KC_LGUI), _______  , _______ , _______  ,            _______  , _______ , _______  , _______  , _______  , S(KC_RALT), S(KC_INT3)
  ),
  ...
  [3] = LAYOUT_universal(
    ...
    LC_LCTL  , SSNP_VRT , _______  , _______  , _______  , _______  ,                                  CPI_D1K  , CPI_D100 , CPI_I100 , CPI_I1K  , KBC_SAVE , KBC_RST  ,
  ...
  [4] = LAYOUT_universal(
    _______  , KC_F1       , KC_F2    , KC_F3    , KC_F4    , KC_F5    ,                                  KC_F6    , KC_F7    , KC_F8    , KC_F9    , KC_F10   , KC_F11   ,
    C(KC_TAB), G(S(KC_F23)), CUT_TEXT , KC_END   , C(KC_R)  , C(KC_T)  ,                                  C(KC_V)  , C(KC_Z)  , KC_TAB   , C(KC_O)  , KC_UP    , KC_F12  ,
    ...
    C(KC_ESC), _______     ,C(KC_LALT),C(KC_LGUI), _______  , SET_MARK , G(S(KC_S))  ,            _______  , C(KC_ENT), _______  , _______  , _______  ,C(KC_RALT), _______ 
  ),
  // Emacs レイヤー (C-x)
  [5] = LAYOUT_universal(
