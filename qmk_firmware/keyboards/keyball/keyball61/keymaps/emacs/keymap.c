...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [2] = LAYOUT_universal(
    ...
    SSNP_VRT , LC_SLSH  , KC_7     , KC_8     , KC_9     , KC_MINS  ,                                  _______  , KC_LEFT  , KC_UP    , KC_RGHT  , _______  , KC_F12   ,
    SSNP_HOR ,S(KC_QUOT), KC_4     , KC_5     , KC_6     ,S(KC_MINS),                                  KC_PGUP  , KC_BTN1  , KC_DOWN  , KC_BTN2  , KC_BTN3  , _______  ,
    _______  , LC_BSPC  , KC_1     , KC_2     , KC_3     ,S(KC_SCLN), S(KC_8)  ,            S(KC_9)  , KC_PGDN  , _______  , _______  , _______  , _______  , _______  ,
